...
Driver is the main object which users of the adapter package will interact with. The
most common interaction is using the ``drive`` method. The overall steps of triggering a
